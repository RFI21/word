...
def detail(keyword):
    api_key = "b3a3c710-29f4-4c14-8074-ea816d7f354a"
...
def error():
    ...
    if words :
        words = request.args.get('words')
        sugesti = request.args.get('sugestions').split('{')
        return render_template('error.html',words=words,sugestions=sugesti)
